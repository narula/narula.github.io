...
Which makes this all frustrating, and exciting! If you think A is basically 0, I get why you don’t want to bother with all this complexity. I do not have the background or interest to evaluate A from first principles myself, and I don’t trust most people on the internet to be able to do this effectively either. I rely on the [expertise of others who I know and trust](https://scottaaronson.blog/?p=9665). **Based on this, let me make my position clear: A is high enough to warrant prioritizing designing, implementing, and evaluating post-quantum signature schemes and consensus upgrades in Bitcoin now.**
